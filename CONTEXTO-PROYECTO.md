...
>
> **Versión:** NeoConnect COMPLETO · NeoProfit (Sprint 22) · Onboarding · Branding · Backend NeoCloud Mobile (B-1…B-6) · Scalar · Plan-V2 (M1 paridad Web↔API · M2 OCR Gemini + Push FCM · M3 health+auditoría · M5 tests integración + CI) · **Rama:** `main` · **Build:** ✅ 0 errores · **Tests:** 436 unit + 7 integración

...
`Billing:Calendar:Enabled=true` habilita el generador mensual idempotente en un host (API). No cobra ni marca pagos automáticamente. Los pagos reales se concilian mediante `IBillingCalendarService` y la herramienta administrativa `tools/ClientCommercial`, con identidad central persistida, importe, referencia y fecha verificables. Checkout y renovación heredada rechazan un acuerdo activo con `BILLING_CALENDAR_MANAGED`.
...
- Requiere migraciones GL1H-A y `20260905043506_GL1H_WompiPaymentInbox`. [Detalle H04 y evidencia](../../docs/auditoria-2026-09-03/GL1H-B-Webhook-Wompi-Durable.md); [configuración sin secretos](../../docs/auditoria-2026-09-03/Wompi-Modelo-Tarifas-Configuracion.md).
...
Ver [cierre y evidencia GL1G](../../docs/auditoria-2026-09-03/GL1G-Cierre-Coordinacion-Billing-2026-09-04.md).
...
[Contrato para Manuel y límites de recuperación](../../docs/auditoria-2026-09-03/Avance-GL1C-Diagnostico-Recuperacion.md).
...
[Contrato, evidencia y límites de recuperación](../../docs/auditoria-2026-09-03/Avance-GL1B-Idempotencia.md).
...
[Verificación, alcance y siguientes pasos](../../docs/auditoria-2026-09-03/Avance-GL1A-Integridad-Fiscal.md).
...
Ver [avance y evidencia](../../docs/auditoria-2026-09-03/Avance-GL0A.md).

...
public interface IProfitService
{
    ...
    // Gastos
    Task<Result<PagedResult<ProfitGastoDto>>> ListGastosAsync(int empresaId, PagedQuery query, ProfitPeriodoQuery? periodo = null, CancellationToken ct = default);
    ...
    // Compras
    Task<Result<PagedResult<ProfitCompraDto>>> ListComprasAsync(int empresaId, PagedQuery query, ProfitPeriodoQuery? periodo = null, CancellationToken ct = default);

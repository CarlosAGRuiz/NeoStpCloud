...
`dotnet test NeoSTP.slnx` quedo verde con 725 unitarias + 9 integracion. HB-1 no cambio contratos HTTP
...
sin modificar endpoints/DTOs mobile. V3-S1/V3-S2 agregaron rutas de ordenes/recepciones bajo Compras sin cambiar el
